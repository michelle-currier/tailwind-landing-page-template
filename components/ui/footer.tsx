...
export default function Footer({ border = false }: { border?: boolean }) {
  return (
    <footer>
      ...
      {/* Big text */}
      <div className="relative -mt-8 h-80 w-full" aria-hidden="true">
        <div className="pointer-events-none absolute left-1/2 -z-10 -translate-x-1/2 text-center text-[348px] font-bold leading-none before:bg-gradient-to-b before:from-gray-200 before:to-gray-100/30 before:to-80% before:bg-clip-text before:text-transparent before:content-['Clean'] after:absolute after:inset-0 after:bg-gray-300/70 after:bg-clip-text after:text-transparent after:mix-blend-darken after:content-['Clean'] after:[text-shadow:0_1px_0_white]"></div>
        {/* Glow */}
        <div
