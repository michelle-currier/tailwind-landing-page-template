      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="pb-12 pt-32 md:pb-20 md:pt-40">
          ...
          <div className="pb-12 text-center md:pb-16">
            <h1
              className="font-lobster mb-6 border-y text-5xl font-bold [border-image:linear-gradient(to_right,transparent,theme(colors.slate.300/.8),transparent)1] md:text-6xl"
              data-aos="zoom-y-out"
              data-aos-delay={150}
            >
